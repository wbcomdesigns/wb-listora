...
Authored journeys (**185** total — 20 customer / 18 admin / **144** regression / 3 system; Pro carries a further 93). The tables below are a curated highlight subset and are not maintained per-journey; `docs/qa/journeys/` is the full index and the only count worth trusting:
