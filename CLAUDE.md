...
Authored journeys (138 total — 20 customer / 18 admin / 96 regression / 3 system). The tables below are a curated highlight subset; `docs/qa/journeys/` is the full index:
