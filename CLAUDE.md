...
Authored journeys (134 total — 20 customer / 18 admin / 93 regression / 3 system). The tables below are a curated highlight subset; `docs/qa/journeys/` is the full index:
