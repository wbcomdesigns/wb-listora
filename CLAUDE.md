...
Authored journeys (135 total — 20 customer / 18 admin / 94 regression / 3 system). The tables below are a curated highlight subset; `docs/qa/journeys/` is the full index:
