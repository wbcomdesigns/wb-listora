...
(() => {
/*!****************************************!*\
  !*** ./src/blocks/listing-map/view.js ***!
  \****************************************/
...
function createMarker(data) {
  ...
  const ratingHtml = data.rating > 0 ? `<span class="listora-map__popup-rating">★ ${data.rating.toFixed(1)}</span>` : '';
  const featuredHtml = data.featured ? '<span class="listora-badge listora-badge--featured" style="font-size:0.65rem">Featured</span>' : '';
  const popupHtml = `
