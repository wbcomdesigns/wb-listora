	...
	<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,sans-serif;color:#1e1e1e;">
		...
		<tr>
			<td style="padding:1.5rem 2rem;background:#dba617;text-align:center;">
				<p style="margin:0;font-size:1.1rem;font-weight:600;color:#ffffff;">
					<?php esc_html_e( 'Your listing needs changes', 'wb-listora' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr>
			<td style="padding:2rem;">
				...
				<table cellpadding="0" cellspacing="0" style="margin:0 0 1.5rem;background:#fcf9e8;border-left:4px solid #dba617;border-radius:0 6px 6px 0;padding:1rem;width:100%;">
					<tr>
						<td>
							<p style="margin:0 0 0.3rem;font-size:0.8rem;font-weight:600;color:#646970;text-transform:uppercase;letter-spacing:0.05em;">
				...
				<p style="margin:0 0 0.75rem;font-size:0.9rem;color:#3c434a;">
