 ...
 *
 * Sent to the review author when their review reaches a helpful-vote milestone.
 *
 * Variables available:
 ...
 *   $milestone      (int)    Milestone that was reached (1, 5, 10, 25, 50, 100).
 *
 * @package WBListora
 */
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f0f1;padding:2rem 1rem;">
	...
	<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Oxygen,sans-serif;color:#1e1e1e;">
		...
		<!-- Header -->
		<tr>
			<td style="padding:1.5rem 2rem;background:#2271b1;text-align:center;">
				<p style="margin:0;font-size:1.1rem;font-weight:600;color:#ffffff;">
					<?php esc_html_e( 'Your review is making an impact!', 'wb-listora' ); ?>
				</p>
			</td>
		</tr>
			...
			<td style="padding:2rem;">
				...
				<p style="margin:0 0 1.5rem;font-size:0.95rem;color:#3c434a;line-height:1.6;">
					...
					printf(
						...
						'<strong>' . esc_html( number_format_i18n( $milestone ) ) . '</strong>'
					);
					?>
				</p>
					...
					<tr>
						<td align="center">
							<table cellpadding="0" cellspacing="0" style="background:#f0f6fc;border-radius:8px;padding:1.25rem 2rem;">
								<tr>
									<td align="center">
										<p style="margin:0 0 0.25rem;font-size:2rem;font-weight:700;color:#2271b1;">
											<?php echo esc_html( number_format_i18n( $milestone ) ); ?>
										</p>
										<p style="margin:0;font-size:0.85rem;color:#646970;text-transform:uppercase;letter-spacing:0.05em;">
