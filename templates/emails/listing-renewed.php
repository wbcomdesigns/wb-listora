 ...
 *
 * Confirmation sent to the listing owner when they renew an expired listing.
 *
 * Variables available:
		...
		<tr>
			<td style="padding:1.5rem 2rem;background:#00a32a;text-align:center;">
				<p style="margin:0;font-size:1.1rem;font-weight:600;color:#ffffff;">
					<?php esc_html_e( 'Listing renewed successfully', 'wb-listora' ); ?>
				</p>
			</td>
		</tr>
				...
				<table cellpadding="0" cellspacing="0" style="margin:0 0 1.5rem;background:#f6f7f7;border-radius:6px;padding:1rem;width:100%;">
					<tr>
						<td style="font-size:0.85rem;color:#646970;">
							<strong style="color:#1e1e1e;"><?php esc_html_e( 'New expiration date:', 'wb-listora' ); ?></strong>
