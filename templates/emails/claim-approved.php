 ...
 *
 * Override via: {theme}/wb-listora/emails/claim-approved.php
 *
 * @package WBListora
 */
...
$header_title = __( 'Your claim is approved!', 'wb-listora' );
	...
	<td style="padding:2rem;">
		...
		<p style="margin:0 0 1.5rem;font-size:0.95rem;color:<?php echo esc_attr( $colors['text_muted'] ); ?>;line-height:1.6;">
			...
			printf(
				...
				esc_html__( 'Your claim for "%s" has been approved! You can now manage this listing from your dashboard.', 'wb-listora' ),
