		...
		<tr>
			<td style="padding:1.5rem 2rem;background:#1e1e1e;text-align:center;">
				<p style="margin:0;font-size:1.1rem;font-weight:600;color:#ffffff;">
					<?php esc_html_e( 'New review on your listing', 'wb-listora' ); ?>
				</p>
			</td>
		</tr>
		...
		<tr>
			<td style="padding:2rem;">
				...
				<table cellpadding="0" cellspacing="0" style="margin:0 0 1.5rem;background:#f6f7f7;border-radius:6px;padding:1.25rem;width:100%;">
					<tr>
						<td>
							<p style="margin:0 0 0.5rem;font-size:1.1rem;color:#dba617;letter-spacing:0.05em;">
								<?php echo esc_html( $review_rating ); ?>
							</p>
							<?php if ( ! empty( $review_title ) ) : ?>
							<p style="margin:0 0 0.5rem;font-size:0.95rem;font-weight:600;color:#1e1e1e;">
								<?php echo esc_html( $review_title ); ?>
							</p>
							<?php endif; ?>
							<?php if ( ! empty( $review_content ) ) : ?>
							<p style="margin:0;font-size:0.875rem;color:#646970;line-height:1.5;">
