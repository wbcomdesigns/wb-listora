...
| Any specific hook count ("199 hooks", "226 hooks", "259 hooks") | Every figure quoted here has been wrong at some point, including two in this row before 2026-08-22. The count moves every release; at 1.7.0 it is 328 in Free and 258 in Pro, generated by `bin/build-hooks-reference.py` from `audit/manifest.json`. | Do not quote a number. Say "hundreds of documented hooks" or link the generated hooks reference, which cannot go stale. |
