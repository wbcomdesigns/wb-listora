...
1. Visit [wbcomdesigns.com](https://wbcomdesigns.com) and log in to your account.
...
- To restore updates, renew your license at wbcomdesigns.com and click **Check Status**.

## Tips

- Keep the license key stored somewhere safe (e.g., your password manager). You can always retrieve it from your wbcomdesigns.com account.
