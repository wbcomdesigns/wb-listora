/**
 * Listing Categories Block — Editor registration.
 *
 * @package WBListora
 */
			...
			<>
				<InspectorControls>
					<PanelBody title={ __( 'Content', 'wb-listora' ) }>
						...
						/>
						<NumberControl
							label={ __( 'Limit', 'wb-listora' ) }
							value={ attributes.limit }
							onChange={ ( limit ) => setAttributes( { limit: Number( limit ) } ) }
							min={ 1 }
							max={ 50 }
						/>
					</PanelBody>
