/**
 * Listing Submission Block — Editor registration.
 *
 * @package WBListora
 */
				...
				<InspectorControls>
					<PanelBody title={ __( 'Content', 'wb-listora' ) }>
						<TextControl
							...
							help={ __( 'Leave empty to show type selector.', 'wb-listora' ) }
						...
						<SelectControl
							...
							options={ [
								{ label: __( 'Dashboard', 'wb-listora' ), value: 'dashboard' },
								{ label: __( 'Listing', 'wb-listora' ), value: 'listing' },
								{ label: __( 'Homepage', 'wb-listora' ), value: 'homepage' },
							] }
					...
					<PanelBody title={ __( 'Display', 'wb-listora' ) } initialOpen={ false }>
						<ToggleControl
							label={ __( 'Show Type Step', 'wb-listora' ) }
