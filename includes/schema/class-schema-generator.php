		...
		add_action(
			...
			function () {
				...
				if ( ! is_singular() && ! empty( $_GET ) ) {
					$filter_params = array_diff_key( $_GET, array_flip( array( 'page', 'sort', 'paged', 'listora_page', 'listora_sort' ) ) ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
